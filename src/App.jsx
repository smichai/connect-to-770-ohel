...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] text-slate-100 flex flex-col items-center justify-center p-4 sm:p-6 relative font-sans selection:bg-[#E5B54F] selection:text-black overflow-x-hidden" dir="rtl">
      ...
      <div className="relative z-10 max-w-2xl w-full text-center space-y-6 py-8 px-4 sm:px-8 mx-auto flex flex-col items-center justify-center my-auto bg-white/[0.04] backdrop-blur-2xl border border-white/20 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.7)] shadow-[#E5B54F]/5 relative overflow-hidden transition-all">
        ...
        {/* Form - Apple Pure Crystal Glass Containers */}
        <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto space-y-5 pt-2 text-center flex flex-col items-center">
          ...
          <div className="w-full space-y-4">
            {namesList.map((item, index) => (
              <div key={item.id} className="w-full space-y-3 text-center relative bg-white/[0.03] backdrop-blur-xl border border-white/15 p-4 rounded-2xl shadow-lg transition-all duration-300 hover:border-[#E5B54F]/40 hover:bg-white/[0.06]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                  <input
                    ...
                    className="w-full bg-white/[0.05] border border-white/15 focus:border-[#E5B54F] focus:ring-2 focus:ring-[#E5B54F]/30 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-300 text-center focus:outline-none backdrop-blur-md transition-all shadow-inner"
                  />
                  <input
                    type="text"
                    required
        ...
        <a
          ...
          className="max-w-sm w-full mx-auto p-3.5 rounded-2xl bg-emerald-500/[0.08] border border-emerald-400/30 hover:border-emerald-400/60 backdrop-blur-xl flex items-center justify-between gap-3 text-right transition-all duration-300 group shadow-lg hover:bg-emerald-500/[0.12] mt-1"
        >
      ...
      {isClockVisible && !isClockMinimized && (
        <div className="fixed bottom-4 right-3 sm:right-8 z-50 flex flex-col items-center text-center bg-white/[0.05] backdrop-blur-2xl border border-white/20 p-3 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.7)] shadow-[#E5B54F]/10 hover:border-[#E5B54F]/40 transition-all duration-300 max-w-[260px] w-full relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 justify-center w-full pt-0.5" style={{ direction: 'ltr' }}>
            ...
            <div className="flex flex-col items-center gap-0.5">
              <div className="flex gap-0.5" style={{ direction: 'ltr' }}>
                <div className="relative w-6 h-8 bg-white/[0.08] backdrop-blur-md text-white font-sans font-bold text-sm rounded-lg border border-white/20 shadow-md flex items-center justify-center overflow-hidden">
        ...
        {isClockVisible && isClockMinimized && (
          <div className="fixed bottom-4 right-3 z-50">
            <button
              ...
              className="bg-white/[0.06] backdrop-blur-2xl border border-[#E5B54F]/50 text-amber-200 hover:text-white px-3.5 py-2 rounded-full shadow-2xl flex items-center gap-2 text-xs font-bold transition-all hover:scale-105 group"
              title="פתח שעון"
            >
        ...
        {!isClockVisible && (
          <div className="fixed bottom-4 right-3 z-50">
            <button
              ...
              className="bg-white/[0.05] backdrop-blur-md border border-white/20 text-slate-300 hover:text-amber-200 p-2.5 rounded-full shadow-xl transition-all hover:scale-110"
              title="הצג שעון"
            >
              <Clock size={16} />
            </button>
